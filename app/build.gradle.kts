...
dependencies {
    ...
    // CameraX for QR scanning (camera access only — decoding is Rust via UniFFI)
    ...
    if (useLocalBindings) {
        ...
        implementation("app.vauchi:vauchi-platform:0.51.25")
    }
    ...
    if (useLocalBindings) {
        ...
        screenshotTestImplementation("app.vauchi:vauchi-platform:0.51.25")
    }

 ...
 *
 * Launch via ADB:
 *   adb shell am start -n com.vauchi/.diagnostic.BleDiagnosticActivity --es test discovery
 *   adb shell am start -n com.vauchi/.diagnostic.BleDiagnosticActivity --es test mtu
 *   adb shell am start -n com.vauchi/.diagnostic.BleDiagnosticActivity --es test throughput
 *   adb shell am start -n com.vauchi/.diagnostic.BleDiagnosticActivity --es test latency
 *   adb shell am start -n com.vauchi/.diagnostic.BleDiagnosticActivity --es test rssi
 *   adb shell am start -n com.vauchi/.diagnostic.BleDiagnosticActivity --es test stability
 *   adb shell am start -n com.vauchi/.diagnostic.BleDiagnosticActivity --es mode server
 */

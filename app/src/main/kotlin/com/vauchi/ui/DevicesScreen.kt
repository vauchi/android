            ...
            item {
                ...
                Card(
                    ...
                    Column(modifier = Modifier.padding(16.dp)) {
                        ...
                        Text(
                            text = "vauchi device link    - Generate link code",
                            style = MaterialTheme.typography.bodySmall,
                            color = MaterialTheme.colorScheme.outline
                        )
                        Text(
                            text = "vauchi device join    - Join with code",
                            style = MaterialTheme.typography.bodySmall,
                            color = MaterialTheme.colorScheme.outline
                        )
                        Text(
                            text = "vauchi device list    - List all devices",
                            style = MaterialTheme.typography.bodySmall,
                            color = MaterialTheme.colorScheme.outline
                        )
                    }
        ...
        AlertDialog(
            ...
            text = {
                Column {
                    ...
                    Spacer(modifier = Modifier.height(8.dp))
                    Text(
                        text = "Note: Device joining requires CLI. Use: vauchi device join <code>",
                        style = MaterialTheme.typography.bodySmall,
                        color = MaterialTheme.colorScheme.outline
                    )
                }
